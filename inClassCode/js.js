...
// // const pantsArray = ["Haggar", "Levis", "Docker", "Unionbay"]
...
// // pantsArray.shift();
// // console.log(pantsArray);
// // pantsArray.unshift("sonoma");
// // console.log(pantsArray);

// // // Array.splice(start, delete, element, element2....)
...
// console.log([4, 6, 8, 14, 16, 18].find(isPrime));
...
// // element is 5
// // 2 <= Math.sqrt(4) = 2 <= 2.23607 = true
// //      is 2.23607 % 2 < 1 // false
// //      start = 3
// // 3 <= Math.sqrt(5)
// // 3 is <= Math.sqrt(5) = false
// // end while loop
// // return 5

// //Array.filter()
// const string2 = ["function", "hello", "startup", "web"];
// const longwords = string2.filter(word => word.length > 6);
...
// // Array.slice()
// const petsArray = ["cat", "dog", "bird", "fish", "rabbit"];
// console.log(petsArray);
// const petsArray2 = petsArray.slice(2, 4);
// console.log(petsArray2);
// console.log(petsArray.slice(1));
